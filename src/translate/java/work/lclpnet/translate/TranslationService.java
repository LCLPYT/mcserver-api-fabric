package work.lclpnet.translate;

import net.minecraft.server.network.ServerPlayerEntity;
import net.minecraft.util.Identifier;
import work.lclpnet.kibu.access.PlayerLanguage;
import work.lclpnet.translate.bossbar.BossBarProvider;
import work.lclpnet.translate.bossbar.TranslatedBossBar;
import work.lclpnet.translate.pref.LanguagePreferenceProvider;
import work.lclpnet.translate.text.RootText;
import work.lclpnet.translate.text.TextFormatter;
import work.lclpnet.translate.text.TranslatedText;
import work.lclpnet.translate.util.Partial;
